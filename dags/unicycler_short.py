...
with DAG(
    ...
    task1 = DockerOperator(
        ...
        # command='unicycler -1 {{ params.short_1 }} -2 {{ params.short_2 }} -o {{ params.output_directory }} '
        # '--min_fasta_length {{ params.min_fasta_length }} --keep {{ params.keep }} --mode {{ params.mode }} '
